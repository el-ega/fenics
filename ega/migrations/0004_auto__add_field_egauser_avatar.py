...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EgaUser.avatar'
        db.add_column(u'ega_egauser', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EgaUser.avatar'
        db.delete_column(u'ega_egauser', 'avatar')
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "'r3DpwRfBjxJK8mptAkil'", 'unique': 'True', 'max_length': '20'}),
