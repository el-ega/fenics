...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EgaUser.invite_key'
        db.alter_column(u'ega_egauser', 'invite_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'EgaUser.invite_key'
        db.alter_column(u'ega_egauser', 'invite_key', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "'c8fyy0OrHxM8o2v73Xcf'", 'unique': 'True', 'max_length': '20'}),
        ...
        u'ega.teamstats': {
            'Meta': {'ordering': "('-points',)", 'object_name': 'TeamStats'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
