...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prediction.trend'
        db.add_column(u'ega_prediction', 'trend',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prediction.trend'
        db.delete_column(u'ega_prediction', 'trend')
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "'yDsnerszURW6JQcWp8Z1'", 'unique': 'True', 'max_length': '10'}),
