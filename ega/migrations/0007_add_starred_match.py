...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.starred'
        db.add_column(u'ega_match', 'starred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.starred'
        db.delete_column(u'ega_match', 'starred')
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "u'mCctHZ7Q1w2CbfhEZe51'", 'unique': 'True', 'max_length': '20'}),
