...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LeagueMember.origin'
        db.delete_column(u'ega_leaguemember', 'origin')


    def backwards(self, orm):
        # Adding field 'LeagueMember.origin'
        db.add_column(u'ega_leaguemember', 'origin',
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "'2AY87XbqY8KoAej9q3HX'", 'unique': 'True', 'max_length': '20'}),
