...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.suspended'
        db.add_column(u'ega_match', 'suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.suspended'
        db.delete_column(u'ega_match', 'suspended')
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "u'DQBMr7Ij2dNjWpBijdGz'", 'unique': 'True', 'max_length': '20'}),
