...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'League', fields ['name']
        db.delete_unique(u'ega_league', ['name'])

        # Removing unique constraint on 'League', fields ['slug']
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'League', fields ['name']
        db.create_unique(u'ega_league', ['name'])
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "u'z8Xog9lg4Vrm3YCWUxFM'", 'unique': 'True', 'max_length': '20'}),
        ...
        u'ega.league': {
            'Meta': {'ordering': "[u'name']", 'unique_together': "((u'name', u'slug', u'tournament'),)", 'object_name': 'League'},
