...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.description'
        db.add_column(u'ega_match', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.description'
        db.delete_column(u'ega_match', 'description')
    ...
    models = {
        ...
        u'ega.egauser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_key': ('django.db.models.fields.CharField', [], {'default': "u'84u5WKhTvindEzDmzLPa'", 'unique': 'True', 'max_length': '20'}),
        ...
        u'ega.league': {
            'Meta': {'ordering': "[u'name']", 'object_name': 'League'},
